...
Trajectory::Parameters pa_faststraight_start[] = {
	...
	Trajectory::Parameters(	0,	550,	1100,	5000),
	Trajectory::Parameters(	0,	650,	1200,	6000)
};
...
Trajectory::Parameters pa_faststraight[] = {
	...
	Trajectory::Parameters(	550,	550,	1100,	5000),
	Trajectory::Parameters(	650,	650,	1200,	6000)
};
...
Trajectory::Parameters pa_faststraight_end[] = {
	...
	Trajectory::Parameters(	550,	0,	550,	5000),
	Trajectory::Parameters(	650,	0,	650,	6000)
};
